...
class SymmetricDecryption extends React.Component {
  ...
  componentDidMount() {
    axios.get("http://localhost:3001/symmetricEncryptionGet")
      .then(res => {
  ...
  async handleSubmit(event) {
    ...
    //get response
    await axios.get("http://localhost:3001/symmetricDecryptionGet")
      .then(res => {
      ...
      <React.Fragment>
        <Container>
          ...
          <Form onSubmit={this.handleSubmit}>
            <p>Automatski je izvađena datoteka <b>tajni_kljuc.txt</b></p>
            ...
            <Form.Group>
              ...
              <Form.Text className="text-muted">
                Upisani kriptirani tekst automatski je izvađen iz datoteke <b>"symmetric_encryption_file.txt"</b>
              </Form.Text>
            </Form.Group>
